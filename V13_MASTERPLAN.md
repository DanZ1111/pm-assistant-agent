...
| v1.3 Build 02 | Overview Project Pulse | Add derived status/attention/next-action section. |
...
11. **Deferred:** Sandbox implementation, detailed product-spec schema, designer portal backend, and full timeline template engine.
